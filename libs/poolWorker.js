...
const ShareLogger = require('./logging/rewardLogger');
...
module.exports = function (logger) {
    ...
    const shareLogger = new ShareLogger('logs/shares_logger');
    ...
    Object.keys(poolConfigs).forEach(function (coin) {
        ...
        pool.on('share', function (isValidShare, isValidBlock, data) {
            ...
            if (isValidShare) {
                ...
                shareLogger.log('Share accepted at diff ' + data.difficulty + '/' + data.shareDiff + ' by ' + data.worker + '.');
